...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	CCScriptEngineManager::sharedScriptEngineManager()->getScriptEngine()->executeScriptFile("./../../HelloLua/scripts/main.lua");
...
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
	string path = CCFileUtils::fullPathFromRelativePath("application/scripts/main.lua");
